...
<div class="card">
    <div class="card-body">
        ...
        `;
                    ...
                    <div class="mb-3">
                        <div id="inspectors-container">
                            ...
                            <div class="inspector-entry mb-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control mt-2"
                                        ...
                                        name="inspectors[{{ $loop->index }}][inspector_name]" placeholder="ชื่อกรรมการ"
                            ...
                            <div class="inspector-entry mb-3 d-flex flex-wrap">
                                <div class="flex-fill mb-2 me-2">
                                    <label for="inspectors[0][inspector_name]" class="form-label">ชื่อกรรมการ</label>
                            ...
                            <div class="inspector-entry mb-3 d-flex flex-wrap">
                                <div class="flex-fill mb-2 me-2">
                                    <label for="inspectors[2][inspector_name]" class="form-label">ชื่อกรรมการ</label>
            ...
            <!-- More Section -->
            <div class="card mb-4">
                <h3 class="card-header" style="background-color: #092174;">ข้อมูลเพิ่มเติม</h3>
                <div class="card-body" style="background-color: #6db8ff;">
                    <div class="mb-3">
                        @if ($info->mores->isNotEmpty())
                        @foreach ($info->mores as $index => $more)
                        <div class="more-entry mb-3">
                            <!-- ซ่อน input สำหรับ id ของ More -->
                            <input type="hidden" name="mores[{{ $index }}][id]"
                                value="{{ old('mores.'.$index.'.id', $more->id ?? '') }}">

                            <div class="mb-2">
                                <label for="mores[{{ $index }}][price_list]" class="form-label">ใบเสนอราคา</label>
                                <input type="text" class="form-control" id="mores[{{ $index }}][price_list]"
                                    name="mores[{{ $index }}][price_list]"
                                    value="{{ old('mores.'.$index.'.price_list', $more->price_list ?? '') }}"
                                    placeholder="ใบเสนอราคา" required>
                            </div>
                            ...
                            <div class="mb-2">
                                <label for="mores[{{ $index }}][middle_price_first]"
                                    class="form-label">แหล่งที่มาของราคากลาง 1</label>
                                <input type="text" class="form-control" id="mores[{{ $index }}][middle_price_first]"
                                    name="mores[{{ $index }}][middle_price_first]"
                                    value="{{ old('mores.'.$index.'.middle_price_first', $more->middle_price_first ?? '') }}"
                                    placeholder="แหล่งที่มาของราคากลาง 1" required>
                            </div>

                            <div class="mb-2">
                                <label for="mores[{{ $index }}][middle_price_second]"
                                    class="form-label">แหล่งที่มาของราคากลาง 2</label>
                                <input type="text" class="form-control" id="mores[{{ $index }}][middle_price_second]"
                                    name="mores[{{ $index }}][middle_price_second]"
                                    value="{{ old('mores.'.$index.'.middle_price_second', $more->middle_price_second ?? '') }}"
                                    placeholder="แหล่งที่มาของราคากลาง 2" required>
                            </div>

                            <div class="mb-2">
                                <label for="mores[{{ $index }}][middle_price_third]"
                                    class="form-label">แหล่งที่มาของราคากลาง 3</label>
                                <input type="text" class="form-control" id="mores[{{ $index }}][middle_price_third]"
                                    name="mores[{{ $index }}][middle_price_third]"
                                    value="{{ old('mores.'.$index.'.middle_price_third', $more->middle_price_third ?? '') }}"
                                    placeholder="แหล่งที่มาของราคากลาง 3" required>
                            </div>
                        </div>
                        @endforeach
                        @else
