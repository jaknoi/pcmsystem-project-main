        ...
        <div class="d-flex flex-column align-items-center">
            ...
            <div class="mb-5"> <!-- เพิ่มระยะห่างระหว่างการ์ด -->
                <div class="card custom-card">
                    <a href="{{ route('login') }}" class="btn-img">
                        <img src="{{ asset('images/') }}" class="card-img-top custom-card-img" alt="Image 1">
                    </a>
                </div>
            </div>
            ...
            <div>
                <div class="card custom-card">
                    <a href="{{ route('signup') }}" class="btn-img">
                    <img src="{{ asset('images/') }}" class="card-img-top custom-card-img" alt="Image 2">
                </div>
            </div>
        </div>
    </div>
