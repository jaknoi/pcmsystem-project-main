...
'fonts' => [
    'THSarabunIT๙' => [
        'normal' => public_path('fonts/THSarabunIT๙.ttf'),
        'bold' => public_path('fonts/THSarabunIT๙.ttf'), // หากคุณมีเวอร์ชันหนา
        'italic' => public_path('fonts/THSarabunIT๙.ttf'), // หากคุณมีเวอร์ชันเอียง
        'bold_italic' => public_path('fonts/THSarabunIT๙.ttf'), // หากคุณมีเวอร์ชันหนา-เอียง
    ],
],
